...
// IpIntelligenceApi2 SDK utility: fetcher

class IpIntelligenceApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpIntelligenceApi2SDK/1.0)';
    ...
    public static function call(IpIntelligenceApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
