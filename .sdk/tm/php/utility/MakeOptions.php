...
// IpIntelligenceApi2 SDK utility: make_options

class IpIntelligenceApi2MakeOptions
{
    ...
    public static function call(IpIntelligenceApi2Context $ctx): array
    {
        ...
        //
        // `IpIntelligenceApi2Schema::optspec()` is built from the model:
        ...
        $optspec = IpIntelligenceApi2Schema::optspec();
