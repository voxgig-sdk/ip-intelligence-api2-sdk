...
// IpIntelligenceApi2 SDK utility: result_basic

class IpIntelligenceApi2ResultBasic
{
    public static function call(IpIntelligenceApi2Context $ctx): ?IpIntelligenceApi2Result
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof IpIntelligenceApi2Error) ? $result->err->msg : (string)$result->err;
