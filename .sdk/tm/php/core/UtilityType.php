...
// IpIntelligenceApi2 SDK utility type

class IpIntelligenceApi2Utility
{
    ...
    public static function copy(IpIntelligenceApi2Utility $src): IpIntelligenceApi2Utility
    {
        $u = new IpIntelligenceApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
