...
// IpIntelligenceApi2 SDK feature test
//
...
class FtCtrl extends IpIntelligenceApi2Control
{
...
class FtClient
{
    ...
    private IpIntelligenceApi2Utility $utility;

    public function __construct(IpIntelligenceApi2Utility $utility, array $options)
    {
    ...
    public function get_utility(): IpIntelligenceApi2Utility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (IpIntelligenceApi2Context $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public IpIntelligenceApi2Context $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (IpIntelligenceApi2Context $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = IpIntelligenceApi2Config::make_feature($name);
    ...
    private static function buildUrl(IpIntelligenceApi2Spec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof IpIntelligenceApi2Error) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new IpIntelligenceApi2Response($fetched);
        }
    ...
    private function fail(IpIntelligenceApi2Context $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (IpIntelligenceApi2Context $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
