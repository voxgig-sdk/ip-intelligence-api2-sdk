...
// IpIntelligenceApi2 SDK retry feature
...
class IpIntelligenceApi2RetryFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    public function init(IpIntelligenceApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpIntelligenceApi2Context $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(IpIntelligenceApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(IpIntelligenceApi2Context $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
