...
// IpIntelligenceApi2 SDK clienttrack feature
...
class IpIntelligenceApi2ClienttrackFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    public function PostConstruct(IpIntelligenceApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpIntelligenceApi2-SDK';
