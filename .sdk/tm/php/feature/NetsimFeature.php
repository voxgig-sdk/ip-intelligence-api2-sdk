...
// IpIntelligenceApi2 SDK netsim feature
...
class IpIntelligenceApi2NetsimFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    private function _simulate(IpIntelligenceApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpIntelligenceApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
