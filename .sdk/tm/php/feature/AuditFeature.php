...
// IpIntelligenceApi2 SDK audit feature
...
class IpIntelligenceApi2AuditFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    private function _emit(IpIntelligenceApi2Context $ctx, string $outcome): void
    {
