...
// IpIntelligenceApi2 SDK ratelimit feature
...
class IpIntelligenceApi2RatelimitFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    private function _acquire(IpIntelligenceApi2Context $ctx): void
    {
    ...
    private function _track(IpIntelligenceApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
