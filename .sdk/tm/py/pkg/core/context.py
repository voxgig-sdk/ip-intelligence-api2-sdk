...
from projectname_sdk.core.control import IpIntelligenceApi2Control
...
class IpIntelligenceApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpIntelligenceApi2Control()
        ...
        if isinstance(sp, IpIntelligenceApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpIntelligenceApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpIntelligenceApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IpIntelligenceApi2Operation({})
        ...
        op = IpIntelligenceApi2Operation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return IpIntelligenceApi2Error(code, msg, self)
