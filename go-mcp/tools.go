...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_ip_info"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpIntelligenceApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-intelligence-api2_list",
		Description: "List records from IpIntelligenceApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-intelligence-api2_load",
		Description: "Load a single record from IpIntelligenceApi2. " +
...
func runOp(client *sdk.IpIntelligenceApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpIntelligenceApi2SDK, name string) (sdk.IpIntelligenceApi2Entity, error) {
	switch strings.ToLower(name) {
	case "get_ip_info":
		return client.GetIpInfo(nil), nil
