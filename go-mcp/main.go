// Command IpIntelligenceApi2-mcp is an MCP server exposing the IpIntelligenceApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpIntelligenceApi2_list  — list records of an entity
//	IpIntelligenceApi2_load  — load a single record of an entity
//
