...
describe("GetIpInfoDirect", function()
  it("should direct-load-get_ip_info", function()
    local setup = get_ip_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_ip_info", setup.live and "live" or "unit")
...
function get_ip_info_direct_setup(mockres)
