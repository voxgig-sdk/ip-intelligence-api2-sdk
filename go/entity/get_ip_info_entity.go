...
type GetIpInfoEntity struct {
	name    string
	client  *core.IpIntelligenceApi2SDK
...
func NewGetIpInfoEntity(client *core.IpIntelligenceApi2SDK, entopts map[string]any) *GetIpInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetIpInfoEntity) GetName() string { return e.name }
...
func (e *GetIpInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetIpInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *GetIpInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetIpInfoEntity(e.client, opts)
}

func (e *GetIpInfoEntity) Data(args ...any) any {
...
func (e *GetIpInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetIpInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetIpInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetIpInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetIpInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetIpInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetIpInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
