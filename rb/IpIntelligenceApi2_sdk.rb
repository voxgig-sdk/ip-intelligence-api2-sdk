...
require_relative 'IpIntelligenceApi2_types'
...
class IpIntelligenceApi2SDK
  ...
  def initialize(options = {})
    ...
    utility = IpIntelligenceApi2Utility.new
    @_utility = utility
    ...
    feature_opts = IpIntelligenceApi2Helpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = IpIntelligenceApi2Helpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, IpIntelligenceApi2Features.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    IpIntelligenceApi2Utility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = IpIntelligenceApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = IpIntelligenceApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = IpIntelligenceApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => IpIntelligenceApi2Error.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue IpIntelligenceApi2Error => err
    ...
    if fetched.is_a?(Hash)
      status = IpIntelligenceApi2Helpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = IpIntelligenceApi2Error.new(
        "graphql_error", "IpIntelligenceApi2SDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = IpIntelligenceApi2SDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
