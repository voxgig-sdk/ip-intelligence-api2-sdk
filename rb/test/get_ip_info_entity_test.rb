...
class GetIpInfoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IP_INTELLIGENCE_API2_TEST_GET_IP_INFO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def get_ip_info_basic_setup(extra)
  ...
  entid_env_raw = ENV["IP_INTELLIGENCE_API2_TEST_GET_IP_INFO_ENTID"]
