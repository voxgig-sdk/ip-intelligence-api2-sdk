...
#      offline in seeded test mode (IpIntelligenceApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpIntelligenceApi2_sdk.rb")
  SDK_CLASS = "IpIntelligenceApi2SDK"
  ...
  SDK_BASE = "IpIntelligenceApi2_sdk"
