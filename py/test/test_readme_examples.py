# IpIntelligenceApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpIntelligenceApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpIntelligenceApi2SDK(...) and IpIntelligenceApi2SDK.test(...) become
#      IpIntelligenceApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipintelligenceapi2_sdk"
_SDK_CLASS = "IpIntelligenceApi2SDK"
