...
from ipintelligenceapi2_sdk.utility import register

# Load features
from ipintelligenceapi2_sdk.feature.base_feature import IpIntelligenceApi2BaseFeature
from ipintelligenceapi2_sdk.features import _has_feature, _make_feature
...
class IpIntelligenceApi2SDK:
    ...
    def get_utility(self):
        return IpIntelligenceApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpIntelligenceApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetIpInfo(self, data=None) -> "GetIpInfoEntity":
        ...
        from ipintelligenceapi2_sdk.entity.get_ip_info_entity import GetIpInfoEntity
        return GetIpInfoEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "IpIntelligenceApi2SDK":
        if sdkopts is None:
            sdkopts = {}
