# IpIntelligenceApi2 Python SDK Reference

Complete API reference for the IpIntelligenceApi2 Python SDK.
...
#### `IpIntelligenceApi2SDK.test(testopts=None, sdkopts=None)`
