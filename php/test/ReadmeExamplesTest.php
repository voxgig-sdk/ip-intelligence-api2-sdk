...
// IpIntelligenceApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpIntelligenceApi2SDK::test)
...
{
    private const SDK_CLASS = 'IpIntelligenceApi2SDK';
    ...
    private const SDK_BASE = 'ipintelligenceapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipintelligenceapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
