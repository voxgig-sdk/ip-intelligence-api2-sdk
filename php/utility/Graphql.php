...
// IpIntelligenceApi2 SDK utility: graphql
//
...
class IpIntelligenceApi2Graphql
{
    ...
    // equivalent.
    public static function body(IpIntelligenceApi2Context $ctx): mixed
    {
    ...
    public static function errors(IpIntelligenceApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
