...
// IpIntelligenceApi2 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpIntelligenceApi2TestFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    public function init(IpIntelligenceApi2Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpIntelligenceApi2Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = IpIntelligenceApi2Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpIntelligenceApi2Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpIntelligenceApi2Context $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = IpIntelligenceApi2Param::call($ctx, $k);
