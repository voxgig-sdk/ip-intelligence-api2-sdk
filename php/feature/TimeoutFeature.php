...
// IpIntelligenceApi2 SDK timeout feature
...
class IpIntelligenceApi2TimeoutFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    private function _with_timeout(IpIntelligenceApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpIntelligenceApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
