...
// IpIntelligenceApi2 SDK rbac feature
...
class IpIntelligenceApi2RbacFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    private function _required(IpIntelligenceApi2Context $ctx): ?string
    {
    ...
    private function _reject(IpIntelligenceApi2Context $ctx, string $required): void
    {
    ...
    private function _track(IpIntelligenceApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
