...
// IpIntelligenceApi2 SDK proxy feature
...
class IpIntelligenceApi2ProxyFeature extends IpIntelligenceApi2BaseFeature
{
    ...
    public function init(IpIntelligenceApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpIntelligenceApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
