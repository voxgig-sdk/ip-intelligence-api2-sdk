...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.IPINTELLIGENCEAPI2_TEST_LIVE ||
    'TRUE' === process.env.IPINTELLIGENCEAPI2_TEST_OVERRIDE
  ) {
  ...
  m.IPINTELLIGENCEAPI2_TEST_EXPLAIN = process.env.IPINTELLIGENCEAPI2_TEST_EXPLAIN || m.IPINTELLIGENCEAPI2_TEST_EXPLAIN
