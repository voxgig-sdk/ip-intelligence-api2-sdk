...
(0, node_test_1.describe)('GetIpInfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpIntelligenceApi2SDK({
    ...
    (0, node_test_1.test)('direct-load-get_ip_info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_ip_info', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IP_INTELLIGENCE_API2_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpIntelligenceApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IP_INTELLIGENCE_API2_TEST_GET_IP_INFO_ENTID'];
    ...
    const client = new __1.IpIntelligenceApi2SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetIpInfoDirect.test.js.map