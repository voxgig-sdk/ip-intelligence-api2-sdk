...
func registerSDKWords(r *eng.Registry, client *sdk.IpIntelligenceApi2SDK) {
...
func runOp(client *sdk.IpIntelligenceApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
